...
$db->query( "UPDATE cron_scheduler SET run_time = '{$now}', running = 0 WHERE TIMESTAMPDIFF(MINUTE, run_time, '{$now}') > 150 AND cron_type = 'styles' AND frequency != '' AND running = 1" );
